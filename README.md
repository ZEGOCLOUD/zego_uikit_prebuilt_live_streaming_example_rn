...
- To configure prebuilt UI for a custom experience: [Custom Prebuilt UI](https://www.zegocloud.com/docs/uikit/live-streaming-kit-rn/customize-the-livestream/hide-components)
